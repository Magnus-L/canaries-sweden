...
89_wfh_offdiagonal.py -- separating AI exposure from working from home
                         without asking the data to separate two
                         collinear scores.

======================================================================
  RUNS IN MONA. Output folder CANARIES_89_OUT (default output_89).
  No database connection: every input is cached by lanes 28 and 21-22.
======================================================================
...
while the AI term attenuates towards zero. A referee asks the same of
...
The first version of this argument was that remote work is a spent shock
while the step is dated to 2024, so a remote-work reading owes a four-year
lag. ML's correction stands: the return-to-office backlash means
...
L_baseline_2019 (82's pull, cached by lane 28a) and
L_counts_sex_edu_2021 to 2025 (76's pull, cached by lane 21-22), plus
...
IN THE PAPER
Online Appendix III.2, the paragraph answering the remote-work rival;
Section 3, one sentence if Part A discriminates.
"""
...
def build_both(s82, l47, l70, j47) -> tuple:
    ...
    The AI score is rebuilt rather than read from lane 28's export, so
