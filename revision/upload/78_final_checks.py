#!/usr/bin/env python3
"""
78_final_checks.py -- seven checks on the headline design that the vetting
                      round of 22 September asked for, each answerable
                      from the caches already on the share.
...
======================================================================
  ...
  environment variable CANARIES_78_PARTS (default ABCDEFG); the lane
  runner sets it. Budget: A about one hour, B one to two, C one to two,
...
C. INFERENCE BY INDUSTRY. Exposure is a firm-level score shared by firms
   ...
   step, so a referee asks for standard errors clustered by three-digit
   industry beside the employer ones. The headline stock fit is re-run
