...
def main() -> int:
    ...
    note = (
        ...
        r"from the level reached during the tightening months, because the Riksbank interaction stays in the model "
        r"through the post period; the level row re-estimates "
