...
| L4 | `local/l04_public_yreg_check.py` | T13/R2.2 | Extends src/20: SCB YREG54BAS through the newest published year, framed as coverage-immunity evidence |
| L5 | `local/l05_posting_estimators.py` | T4/E6, R1.8 | Poisson (fepois) postings variants beside the OLS specs; kills every ln-percentage statement |
| L6 | `local/l06_seasonality_variant.py` | T14/R1.9 | Occupation-group × calendar-month FE rider |
| L7 | `local/l07_figures_rebuild.py` | T6/E8 | Figure 1 two-panel rebuild (OMXS30 named, units stated, line styles); Figure 2 on Poisson coefficients (fixes D5) |
