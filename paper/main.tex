...
We make three contributions. First, we study \emph{job postings} rather than employment. This matters because the ``scary chart'' itself is about postings, and postings are a leading indicator of labour demand that responds faster than employment to shocks. Nobody has decomposed the posting decline by AI exposure. Second, we use individual-level microdata from Platsbanken, the Swedish Public Employment Service's job bank, comprising over 4.6 million ads (2020--2026) matched to the DAIOE generative AI exposure index at the SSYK 4-digit occupation level \citep{lodefalk2024daioe}. Third, we exploit a natural timing test: Sweden's central bank began raising rates in April 2022 --- seven months before ChatGPT launched in November 2022. The rate hike coincided with Russia's invasion of Ukraine and the ensuing European energy crisis, creating a constellation of macroeconomic headwinds distinct from AI. If AI drives the posting decline in exposed occupations, the differential should emerge or widen after ChatGPT. If macroeconomic tightening is the primary driver, the decline should begin with the rate hike.
...
Five of seven alternative specifications confirm the insignificance of $\hat\beta_2$. However, the all-apps AI exposure measure and tercile classification yield significant ChatGPT coefficients ($p = 0.018$ and $p = 0.026$ respectively), and $\hat\beta_2$ is negative in all specifications. An event study shows no systematic pre-trend, though a joint Wald test on pre-period coefficients rejects at both monthly and quarterly frequency, reflecting differential macro sensitivity rather than trending divergence (see Online Appendix).
...
Our findings complement \citet{kauhanen2025canaries} and \citet{kauhanen2025youth}, who found no AI-driven employment effects in Finland. The dominant driver of the Swedish posting decline is macroeconomic tightening --- the Riksbanken hiking cycle and the broader deterioration following Russia's invasion of Ukraine --- rather than generative AI. However, our results do not support a clean null: $\hat\beta_2$ is negative in seven of eight specifications and statistically significant in two, suggesting possible modest AI effects that our design lacks power to detect precisely. Together, these Nordic studies indicate that the US ``canaries'' finding may partly reflect country-specific labour market institutions.
