...
Two studies have tested the canaries hypothesis outside the US. \citet{kauhanen2025canaries} found no employment decline among young Finnish workers in high-AI-exposure occupations using population register data; instead, wages rose more in these occupations. \citet{kauhanen2025youth} extended the analysis and confirmed no youth labour market effects in Finland through 2024. [Preliminary Danish results using monthly register data suggest a similar canaries pattern (Koch, 2026).]
