...
A ``scary chart'' shows US stock prices rising while job postings fall --- attributed to AI displacement. We test this using 4.6 million Swedish job ads (2020--2026) matched to a generative AI exposure index. A difference-in-differences design exploits the Riksbanken rate hike (April 2022) preceding ChatGPT (November 2022) by seven months. Postings declined broadly across all AI exposure quartiles beginning with monetary tightening, with no significant additional decline after ChatGPT. However, monthly administrative employment data reveal a canaries effect: young workers in AI-exposed occupations experienced disproportionate employment declines. The posting gap reflects macroeconomic tightening; AI operates on employment composition.
\end{abstract}
...
We make three contributions. First, we test \emph{both} the posting margin and the employment margin. Using 4.6 million job ads from Platsbanken (2020--2026) matched to the DAIOE generative AI exposure index \citep{lodefalk2024daioe}, we decompose the aggregate posting decline by AI exposure. We complement this with monthly population-register employment data (AGI) by age group. This dual-margin approach reveals that the same economy can show no AI effect on posting volumes while exhibiting sharp AI-driven compositional shifts in employment. Second, we exploit a natural timing test: Sweden's central bank began raising rates in April 2022 --- seven months before ChatGPT launched in November 2022. The rate hike coincided with Russia's invasion of Ukraine and the ensuing European energy crisis, creating a constellation of macroeconomic headwinds distinct from AI. If AI drives the posting decline in exposed occupations, the differential should emerge or widen after ChatGPT. If macroeconomic tightening is the primary driver, the decline should begin with the rate hike. Third, we provide the first non-US evidence of a canaries effect in employment, contrasting with the Finnish null \citep{kauhanen2025canaries,kauhanen2025youth}.

Our difference-in-differences estimates show that postings declined broadly across all AI exposure quartiles starting in mid-2022, with no significant additional decline in high-exposure occupations after ChatGPT. However, supplementary analysis of monthly population-register employment data reveals that young workers in AI-exposed occupations experienced disproportionate declines --- a ``canaries'' effect consistent with \citet{brynjolfsson2025canaries}. The aggregate posting gap reflects macroeconomic tightening; AI reshapes the composition of hiring within occupations.
...
A difference-in-differences design (Equation~\ref{eq:did}) yields no significant additional decline in high-AI-exposure occupations after ChatGPT ($\hat\beta_2 = -0.062$, $p = 0.11$), while the Riksbanken rate-hike interaction is significant ($\hat\beta_1 = -0.127$, $p < 0.01$). Replacing common time fixed effects with occupation-group $\times$ month fixed effects eliminates both interactions, indicating that the differential reflects different macro sensitivity across occupation groups rather than AI exposure. Six of eight robustness specifications confirm the insignificance of $\hat\beta_2$, though it is negative in seven of eight. A sensitivity analysis following \citet{rambachan2023more} yields a breakdown value of $\bar{M} = 0.25$, confirming the fragility of the AI channel.
...
The contrast between the posting null and the employment canaries in Figure~\ref{fig:canaries} is the paper's key insight. Our posting results complement \citet{kauhanen2025canaries} and \citet{kauhanen2025youth}, who found no AI-driven employment effects among Finnish youth. But in Sweden, the aggregate ``scary chart'' masks a compositional shift: firms continue to post vacancies at similar rates across AI exposure levels, yet young workers in AI-exposed occupations are disproportionately losing employment --- consistent with \citet{brynjolfsson2025canaries}. AI operates on the \emph{composition} of hiring within occupations, not its level. For policy, this distinction matters: interventions targeting aggregate demand cannot address compositional shifts that disproportionately affect young labour market entrants.

Two caveats apply. First, the posting null may partly reflect limited statistical power; the minimum detectable effect is approximately 10 log points. A supplementary analysis finds no significant correlation between AI exposure and monetary policy sensitivity, suggesting the macro confound does not operate through differential rate sensitivity (see Online Appendix). Second, $\text{Post-RB}$ captures the full constellation of early-2022 macroeconomic headwinds --- not monetary policy alone. This confound is not specific to Sweden: all advanced economies experienced synchronised tightening before ChatGPT's launch, so the caution our design implies generalises beyond the Swedish case.
