...
\noindent\textit{Part~I: Data and measurement}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item[A1.] DAIOE exposure distribution
  \item[A2.] Top and bottom occupations
\end{itemize}

\noindent\textit{Part~II: The ``scary chart'' in context}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item[A3.] Sweden vs United States comparison
  \item[A4.] Stock market composition: Sweden vs the US
  \item[A5.] Alternative stock market index (OMXSPI)
\end{itemize}

\noindent\textit{Part~III: Posting analysis}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item[A6.] Individual quartile trends
  \item[A7.] Posting gap: top vs bottom quartile
  \item[A8.] Posting DiD and alternative specifications
  \item[A9.] Alternative AI exposure measure (Eloundou et al.)
  \item[A10.] Event study (monthly)
  \item[A11.] Event study (quarterly)
  \item[A12.] Half-year posting event study
  \item[A13.] Interest rate sensitivity and AI exposure
  \item[A14.] Teleworkability robustness (Dingel-Neiman)
  \item[A15.] Sensitivity to violations of parallel trends
  \item[A16.] Quadratic occupation-specific trends
  \item[A17.] Riksbank policy rate timeline
\end{itemize}

\noindent\textit{Part~IV: Employment analysis}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item[A18.] Employment by age group and AI exposure
  \item[A19.] Employer-level difference-in-differences
  \item[A20.] Spotlight occupations: monthly employment by age (MONA)
\end{itemize}

\noindent\textit{Part~V: Data documentation}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item[A21.] Data sources and access
\end{itemize}
