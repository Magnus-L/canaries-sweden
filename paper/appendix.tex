...
% NOTE: Uncomment figures below once MONA results are available.
% Replace with actual figure files from Lydia's MONA run.

%\begin{figure}[htbp]
%\centering
%\includegraphics[width=\textwidth]{figA8a_mona_canaries_softwaredevelopers.png}
%\caption{Monthly employment by age group --- Software Developers (SSYK~2512). AGI register data, indexed to October 2022 = 100. Vertical lines mark Riksbanken first rate hike (April 2022) and ChatGPT launch (December 2022).}
...
%\caption{Monthly employment by age group --- Customer Service Agents (SSYK~4221, 4222, 5230). AGI register data, indexed to October 2022 = 100. Vertical lines mark Riksbanken first rate hike (April 2022) and ChatGPT launch (December 2022).}
...
%\caption{Monthly employment by age group (16--24 vs 25+) and AI exposure (top quartile vs rest), all occupations. AGI register data, indexed to earliest available month = 100.}
%\label{fig:canaries_agi}
%\end{figure}
