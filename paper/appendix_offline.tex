...
% ══════════════════════════════════════════════════════════════════════════════
%   OA7: Additional corrected event study figures (ages 31-34, 35-40, 50+)
% ══════════════════════════════════════════════════════════════════════════════

\section{Additional corrected event study figures}

The Online Appendix presents corrected event studies (with employer$\times$quartile and employer$\times$month fixed effects) for the three most informative age groups: 22--25, 26--30, and 41--49. The remaining age groups are shown below for completeness. All three exhibit significant pre-trends, limiting their interpretability as standalone tests of parallel trends, but the post-treatment patterns are consistent with the main DiD estimates.
