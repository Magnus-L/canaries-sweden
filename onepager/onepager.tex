...
\colorbox{lightgray}{%
  \parbox{\dimexpr\textwidth-2\fboxsep}{%
    ...
    In the two and a half years after ChatGPT's launch, employment of \textbf{\textcolor{orange}{22--25 year olds}}
...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt, topsep=0pt]
  ...
  \item Beneath this aggregate trend, AI is reshaping
        ...
        losing employment, a shift invisible in aggregate statistics.
  \item The age gradient is \textbf{monotonic}: the younger the worker,
        ...
        shows the gap \textbf{widening through mid-2025}. The result mirrors
        US findings (Brynjolfsson et al., 2025) and contrasts with a Finnish
        null (Kauhanen, 2025); our within-employer design using
        \textbf{full-population} data may capture composition shifts not
        visible at the occupation level.
  \item The effect is \textbf{stronger for women}: young women in
        AI-exposed occupations lost 8.2\% of employment, compared
        with 5.4\% for young men.
\end{itemize}
...
\hfill \textbf{11 March 2026}}

\vspace{0.08cm}
\noindent
{\scriptsize\color{medgray}
\textit{Preliminary results. \href{https://www.ai-econlab.com/papers}{Working paper} forthcoming 16 March 2026.
