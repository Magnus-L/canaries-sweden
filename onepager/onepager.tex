...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt, topsep=0pt]
  ...
  \item The age gradient is \textbf{monotonic}: the younger the worker,
        ...
        contrasts with a Finnish occupation-level null (Kauhanen, 2025);
        our within-employer design may capture composition shifts not
        visible at the occupation level.
\end{itemize}
...
\hfill \textbf{7 March 2026}}

\vspace{0.08cm}
\noindent
{\scriptsize\color{medgray}
\textit{Preliminary results. Working paper forthcoming 13 March 2026.
