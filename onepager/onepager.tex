...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt, topsep=0pt]
  \item The widely noted decline in job postings reflects
        \textbf{monetary tightening}, not AI: it begins with the Riksbank
        rate hike (April 2022), seven months \emph{before} ChatGPT.
  \item Beneath this aggregate null, AI \textbf{appears to be
        reshaping who gets hired}: within the same firms, young workers
        in AI-exposed occupations are disproportionately
        losing employment. \textbf{This shift is invisible
  ...
  \item The effect \textbf{accelerates over time}: by early 2025,
        ...
        but contrasts with Finland, where the same firm-level design
        finds no displacement (Kauhanen \& Rouvinen, 2026).
  ...
  \item \textbf{Caveat:} Pre-trend tests reject formally, but pre-trend
        magnitudes are small and work \emph{against} the finding.
        A placebo test (fake treatment date July 2022) shows no effect at
        the placebo date; the acceleration is specific to the post-ChatGPT period.
\end{itemize}

\section{Policy implications}
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt, topsep=0pt]
  \item \textbf{AI appears to operate on employment composition}, not
        aggregate demand. Targeted interventions are needed alongside
        broader economic policy.
  \item \textbf{Entry-level transition pathways}: vocational education
        (YH) and apprenticeships integrating AI tools.
  \item \textbf{The silver lining}: young workers recover
        faster from displacement than older workers (Athey et al., 2024),
        making early intervention particularly promising.
  \item Monitoring employment \textbf{composition}, not just
        volume, is essential for timely policy response.
\end{itemize}
