...
IN THE PAPER
The coefficients written here are on the education-route score and are
not quoted. The education counts it caches (L_counts_sex_edu_YYYY), the
track definitions and the functions tag_frame, collapse, education_mix,
carry_forward_share and split are imported by script 87, which gives the
within-track row of Table 1 and Online Appendix Tables A15 and A16 on the
occupation-route score, and by scripts 88 and 89.
"""
...
EXPORT_FLOOR = 5
SEX = {"1": "men", "2": "women"}         # Statistics Sweden's coding of Kon
YOUNG = "22-25"
