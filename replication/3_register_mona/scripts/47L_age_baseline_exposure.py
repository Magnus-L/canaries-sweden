...
IN THE PAPER
The L_counts_YYYY caches are the outcome counts behind every employment
estimate (Section 3, Table 1, Figures 2 and 3, Online Appendix III); q_counts
is also called by script 82. build_exposure, build_panel and fit_gradient
are the continuous occupation-scaled route of Online Appendix Table A14,
run by script 63 on three exposure measures. L_baseline_2019 also
supplies the 2019 employment sizes used by script 71. The pooled
estimates in agebase_estimates.csv are not quoted.
"""
...
PAYROLL_CAP_2023 = 25000      # SEK/month; pay ceiling used to flag cells
