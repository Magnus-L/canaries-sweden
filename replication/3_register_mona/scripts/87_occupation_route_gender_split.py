...
composition and within, on script 82's occupation-route score.
...
======================================================================
  ...
  cached from script 76's run.
======================================================================

QUESTION
How much of the female differential of Table 1 survives when young women
are compared with young men holding the same broad education, each
against their own same-track older colleagues? Script 76 answers this on
the education-route score; this script re-runs it on the score the paper
reports, so that the within-track row of Table 1 and the pooled row above
it are one measure and their ratio is meaningful.
...
summary.
  ...
  4. NO SQL. If L_counts_sex_edu_* are not cached the script reports
     that and stops, rather than starting a full read of the monthly
     declarations.
...
L_baseline_2019 (script 82), 47h's caches for the education score book
that prices education groups in the descriptive table, and
L_counts_sex_edu_2021 to 2025 (script 76). Performs no SQL.
...
IN THE PAPER
Table 1, the within-track row; Section 3, the share of the differential
that field of education accounts for; Online Appendix III.2, "Cutting by
field of education", Tables A15 and A16.
"""
...
FLOOR = 5
MATCH_DP = 4
# Table 1's own figure, the gate. Script 82 fitted it on 38,398,914
