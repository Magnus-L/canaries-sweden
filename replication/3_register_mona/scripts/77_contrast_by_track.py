...
not quoted. fit_contrast, POST_FROM, REF_BAND and YOUNG_BANDS are imported
by script 88, which gives the contrasts by field of education that
Section 3 and Online Appendix Table A17 report, on the occupation-route
score.
"""
