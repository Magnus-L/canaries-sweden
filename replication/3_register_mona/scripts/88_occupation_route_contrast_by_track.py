...
education track, on script 82's occupation-route score.
...
QUESTION
Is the shortfall of the young against the prime-aged confined to
particular fields of education? Script 77 cuts the three-band contrast
(22-25 and 26-30 against 41-49) by broad education track on the
education-route score; this script does the same on the score the paper
reports. With script 87, which does the same for the female
differential, it means that no estimate in the paper measures exposure
with the education register; education only divides the sample.
...
INPUTS AND OUTPUTS
Reads L_baseline_2019_cascade and L_baseline_2019 (script 82) and
L_counts_sex_edu_2021 to 2025 (script 76). Performs no SQL. Writes to output_88/:
...
IN THE PAPER
Section 3, the paragraph on fields of education (ICT -0.119, business,
law and administration -0.073); Online Appendix III.2, "Cutting by field
of education", Table A17.
"""
