...
IN THE PAPER
Online Appendix IV.1, Table A25 (built by 4_exhibits from these exports):
Panel A, the share of
...
def stage_a_to_d(panel):
    ...
    # C: composition by quartile of the assigned code. The denominator is
    # coded workers only; read with the attrition-by-quartile table of the
    # submitted version's script 32, it shows whether coverage differs by
    # exposure.
    daioe = mc.load_daioe()
