...
are the outcome behind the hires and separations rows of Table 1 (fitted
by script 82 on the occupation-route classification) and behind the
continuous-route flow estimates of script 63. The estimates in
