...
IN THE PAPER
The coefficients written here are on the education and the first
occupation classification. The first stage the paper reports (Section 2,
20.9 points in the 2023 firm survey; Online Appendix III.2 and Figure A5)
is script 83's Part A, which imports discover, itftg_arm, bita_arm and
firm_size from this script and applies them to the occupation-route
score of script 82.
"""
