...
IN THE PAPER
The sex panel (the caches L_counts_sex_YYYY and flows_sex_YYYY, and
build_skeleton_sex) is the one script 82 fits on the occupation-route
classification with the calendar terms in, which gives the sex rows of
Table 1 and the female differential of Section 3; scripts 80, 87 and 89
use the same skeleton. The coefficients written here are on the
education route without the calendar terms and are not quoted.
"""
